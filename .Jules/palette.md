...
## 2025-02-13 - Add Loading State to Async Auth Buttons
**Learning:** Missing loading states in asynchronous authentication operations (like Google Login) can cause users to click multiple times, potentially leading to race conditions, overlapping network requests, or just a confusing, unresponsive experience.
